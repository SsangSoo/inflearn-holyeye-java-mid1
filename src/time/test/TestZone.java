...
//        ZonedDateTime londonTime = seoulTime.withZoneSameLocal(ZoneId.of("Europe/London"));
        ZonedDateTime londonTime = seoulTime.withZoneSameInstant(ZoneId.of("Europe/London"));
//        ZonedDateTime nyTime = zonedDateTime.withZoneSameLocal(ZoneId.of("America/New_York"));
